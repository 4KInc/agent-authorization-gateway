...
RUN pip install --no-cache-dir google-adk mcp cryptography PyJWT google-cloud-firestore google-cloud-secret-manager google-cloud-logging google-genai web3 eth-account uvicorn httpx fastapi pydantic
